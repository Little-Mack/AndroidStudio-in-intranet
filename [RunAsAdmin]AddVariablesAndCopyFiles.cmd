...
robocopy "%~dp0.android" %pathAndroidStudio%.android\ /nocopy /mt:16 /z /compress /mir
robocopy "%~dp0Sdk" %pathAndroidStudio%Sdk\ /nocopy /mt:16 /z /compress /mir
robocopy "%~dp0Gradle" %pathAndroidStudio%Gradle\ /nocopy /mt:16 /z /compress /mir
robocopy "%~dp0init.d" %pathAndroidStudio%Gradle\init.d\ /nocopy /mt:16 /z /compress /mir
